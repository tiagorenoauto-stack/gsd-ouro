...
/**
 * GSD Ouro — Prompt Generator Pro (v0.4)
...
function buildCOSTAR(objective, options = {}) {
  ...
  return {
    ...
    _meta: { taskType, projectInfo: info, hasKit: ctx.kit.length > 50, hasState: ctx.state.length > 50 },
  };
}
...
function formatXML(fw) {
  ...
  parts.push(`<verify>\nAntes de responder, verifique:\n1. O código segue os padrões do projeto?\n2. Reutiliza componentes do Kit?\n3. Está completo e funcional?\n</verify>`);
